...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="wrapper_new">
            ...
            <div class="col-md-6 col-sm-6">
                <div class="contact_in_left">
                    <h2>Pre Construction Condos Info</h2>

                    <div class="agent_input">
                        <p>
                            Name:<asp:RequiredFieldValidator ID="reqName" runat="server" ErrorMessage="*"
                                ControlToValidate="txtName" ValidationGroup="SaveContactInfo" ForeColor="Red"
    ...
    <asp:TextBox ID="txtPhoneno" CssClass="CTextBox" runat="server" PlaceHolder="Phone Number"></asp:TextBox>
                            ...
                            <asp:RegularExpressionValidator ID="RequiredFieldValidator14" ValidationGroup="DreamHome" runat="server" ControlToValidate="txtPhoneno" Display="Dynamic"
                                ValidationExpression="^(\(\d{3}\) \d{3}-\d{4}|\d{3}-\d{3}-\d{4}|\d{10})$"
                                Text="Enter a valid phone number" ForeColor="Red" />
                            <%--   <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ValidationGroup="SaveContactInfo" runat="server"
                ControlToValidate="txtPhoneno" ForeColor="Red" ValidationExpression="^(\(\d{3}\) \d{3}-\d{4}|\d{3}-\d{3}-\d{4}|\d{10})$"
