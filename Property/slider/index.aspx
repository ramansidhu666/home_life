                        ...
                        <div role="navigation" class="navbar navbar-default">
                            ...
                            <div class="navbar-collapse collapse topnav_new">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="about-us.html" title="About Me">Featured Properties</a></li>
                                    <li><a href="services.html" title="Services">Sellers</a></li>
                                    <li><a href="#" title="Gallery">Buyers</a></li>
                                    <li><a href="#" title="Blog">Links</a></li>
                  ...
                  <asp:Repeater ID="repeater1" runat="server" OnItemDataBound="repeater1_ItemDataBound"  >
                    ...
                    <div>
                      ...
                      <div class="slider_text">
                       ...
                       <%--  <asp:Label ID="lnll" Text ="$"  style="margin-left: 500px;"  runat="server" ></asp:Label>--%>
                          <div class="slider_text2">
                            <asp:Label ID="Label2"   runat="server" Text='<%# Eval("ListPrice")%>' ></asp:Label>
                             <%--<asp:Label ID="Label2" runat="server"  Text='<%# Eval("RemarksForClients").ToString().Substring(0,Eval("RemarksForClients").ToString().IndexOf(".")) %>' ></asp:Label>--%></span></li>
                      </div>
                          </div>
                    </div>
                   </ItemTemplate>
