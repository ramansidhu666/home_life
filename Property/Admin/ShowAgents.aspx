<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ShowAgents.aspx.cs" Inherits="Property.Admin.ShowAgents" %>
        ...
        <div class="content">
            <div class="module">
                ...
                <div class="module-body">
                    <p>
                        <asp:Button ID="btnCreate" runat="server" CssClass="btn btn-primary" Text="Add Agents" OnClick="btnCreate_Click" />
                    ...
                    <asp:GridView ID="grdAgents" AllowPaging="true" class="table table-striped table-bordered table-condensed" PageSize="10" AutoGenerateColumns="False"
