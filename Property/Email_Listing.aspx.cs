    ...
    public partial class Email_Listing : System.Web.UI.Page
    {
        ...
        public string GetPropertyDetails()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                html.AppendLine("<h2 style='font-weight:bold; font-size:16px;'>Rk Sharma for Property ID  " + dt.Rows[0]["MLS"].ToString() + ";</h2>");
                html.AppendLine("<h2 style='font-weight: bold; font-size: 16px;'>Message Received From:</h2>");
                html.AppendLine("<p style='float: left; margin: 0 40px 0 0;'>Phone Number:</p><span style='float:left;'>647-785-2437</span><br/>");
                ...
                html.AppendLine("<p>http://www.rajeshrealtor.com/</p>");
                ...
                html.AppendLine(" 470 CHRYSLER DR UNIT # 20 BRAMPTON, Ontario<br/>Property ID: " + dt.Rows[0]["MLS"].ToString() + "</h2>");
                html.AppendLine("</div>");
                ...
                html.AppendLine("<p>For more information visit <a href='#'>http://www.rajeshrealtor.com/</a> </p></div>");
                html.AppendLine("<div style='float:left; padding-left:12px;'>");
                html.AppendLine("<p style='margin:0px;'>Listed By</p><br/><p>Homelife Miracle<br/>Broker of record</p>");
                //html.AppendLine(" <h2 style='font-size:16px;'>Leading Edge Realty Inc.</h2>");
                html.AppendLine("<p style='margin:0px;'>70 CHRYSLER DR UNIT # 20 BRAMPTON, Ontario</p>");
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>Cell::</p><span style='float:left;'>647-785-2437</span><br/>'");
                ...
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>Website:</p><span style='float:left;'>http://www.rajeshrealtor.com/</span><br/></div></div>");
                html.AppendLine("<div style='float:left; width:100%;'>");
