    ...
    <div class="dt-sc-tabs-container" style="width: 100%;">
        ...
        <div style="display: none;" class="dt-sc-tabs-frame-content">
            ...
            <asp:Button ID="btnCommSearch" runat="server" Text="Search" OnClick="btnCommSearch_Click" />
              <div class="baths-module small-module errorMessage">     <asp:CompareValidator runat="server" CssClass="clsCompare" ID="cpvComm" ControlToValidate="ddlCommMaxPrice"
                ControlToCompare="ddlCommMinPrice" Operator="GreaterThan" Type="Integer" ErrorMessage="Maximum price should be greater than minimum price  " /></div>
        </div>
        <div style="display: none;" class="dt-sc-tabs-frame-content">
            <div class="property-type-module medium-module">
                <span>Type any City, MLSID or PostalCode</span>
            ...
            <div class="errorMessage"> <asp:CompareValidator runat="server" CssClass="clsCompare" ID="cpvCondo" ControlToValidate="ddlCondoMaxPrice"
                ControlToCompare="ddlCondoMinPrice" Operator="GreaterThan" Type="Integer" ErrorMessage="Maximum price should be greater than minimum price  " /></div>
        </div>
    </div>
</div>
